...
namespace App\Modules\POS\Payment\Controllers;
...
use App\Modules\POS\Shift\Models\ShiftCashMovement;
...
class PaymentController extends Controller
{
     ...
     *     description="Process payment and mark order as Paid.",
     *     security={{"bearerAuth":{}}},
     *     @OA\Parameter(name="id", in="path", required=true, @OA\Schema(type="string", format="uuid")),
     *     @OA\RequestBody(
     *         required=true,
     *         @OA\JsonContent(
     *             @OA\Property(property="payment_method_id", type="string", format="uuid"),
     *             @OA\Property(property="amount_tendered", type="number", format="float", example=20.00)
     *         )
     *     ),
     *     @OA\Response(
     *         response=200,
